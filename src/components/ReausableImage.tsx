...
const ReausableImage = ({ image, alt, text, useGradient = true, width = true, fontSize = true, height = true }: Props) => {

  return (
    <div className={`${width ? "h-96" : "h-72"} ${height? "mx-5":""} rounded-2xl flex flex-col items-center relative text-center ${useGradient ? "bg-gradient-to-b from-white to-[#E7FAFE]" : ""}`}>
